...
flatnav_hnsw_recall, flatnav_hnsw_latency = load_dataset(f"{dataset}_flatnav", "metrics_ann_bench.json", "latency_p99")
flatnav_base_recall, flatnav_base_latency = load_dataset(f"{dataset}-base_flatnav", "metrics_ann_bench.json", "latency_p99")
